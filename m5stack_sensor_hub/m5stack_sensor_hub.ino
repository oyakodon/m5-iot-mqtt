...
const char *mqttServer = "<MQTT_BROKER_ADDRESS_HERE>";
...
void notifyCallback(BLERemoteCharacteristic *pBLERemoteCharacteristic, uint8_t *pData, size_t length, bool isNotify)
{
  ...
  if (mqttClient.connected())
  {
    ...
    String json = "{\"value\":" + String(pData[0]) + ",";
    json += "\"timestamp\":" + String(mktime(&timeinfo)) + "}";

    mqttClient.publish("M5Stack", json.c_str());
  }
}
